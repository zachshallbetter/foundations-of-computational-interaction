...
Computational interaction is modeled as a recursive relational system rather than a linear user-interface pipeline. The current ontology incorporates the completed work on representation, scoped invariance, opportunity, interaction, behavior, measurement, similarity, and strategy. CompInt is an interdisciplinary scientific synthesis and research program, not presently an independently justified scientific discipline; future disciplinary recognition remains an empirical question.
