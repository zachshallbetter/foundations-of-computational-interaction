...
CompInt requires those sources of variation to be declared separately.
...
Fundamental can support CompInt by enabling researchers to:
...
CompInt supplies the explanatory questions:
...
CompInt explains why those distinctions matter scientifically. Fundamental provides one way to instantiate them computationally.
