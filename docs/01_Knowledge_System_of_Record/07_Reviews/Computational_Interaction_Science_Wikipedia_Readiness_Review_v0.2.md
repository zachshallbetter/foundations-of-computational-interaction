...
The internal project article has advanced through completed work on strict interaction episodes, behavior and trace evidence, measurement, typed similarity, and strategy. These advances strengthen the project corpus but do not change Wikipedia notability because they remain project-authored or affiliated research.
...
Zachary Shallbetter has a direct professional and intellectual connection to the topic. Wikipedia recommends that connected editors avoid creating the article directly. A future submission should disclose the relationship and use the Articles for Creation review process.
...
The canonical project history may state that the term was introduced by Zachary Shallbetter during the development of Fundamental. A Wikipedia article should include that claim only after an independent reliable source attributes the coinage.

## AI-generated text

Wikipedia's current first-article guidance advises contributors not to use large language models to generate article content. This draft should therefore be treated as research and editorial preparation. A human editor would need to verify every claim and source, rewrite or independently edit the text, disclose any conflict of interest, and accept responsibility for the final submission.
