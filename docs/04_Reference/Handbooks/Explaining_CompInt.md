...
CompInt is a way to answer one question carefully:
...
CompInt preserves those differences instead of calling all of them
“interaction.”
...
| Plain-language question | CompInt distinction |
|---|---|
...
> CompInt is an interdisciplinary scientific synthesis for describing,
