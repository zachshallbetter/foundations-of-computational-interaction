...
This directory contains the reusable CompInt figure set. `FIG-001` is regenerated from its checked-in Graphviz source; the PNG, SVG, and PDF are derivatives and must not be edited directly.
